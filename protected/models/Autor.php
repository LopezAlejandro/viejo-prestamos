...
class Autor extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('nombre, nacionalidad', 'length', 'max'=>45),
			array('nacimiento', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nombre, nacionalidad, nacimiento', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'libroses' => array(self::MANY_MANY, 'Libros', 'libros_has_autor(autor_id, libros_id)'),
		);
	}
